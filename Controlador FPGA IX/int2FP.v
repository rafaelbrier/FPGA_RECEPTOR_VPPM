...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=13 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=13 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 aclr clk_en clock dataa result
...
module  int2FP_altbarrel_shift_rvf
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	reg	[1:0]	dir_pipe;
	reg	[12:0]	sbit_piper1d;
	reg	[12:0]	sbit_piper2d;
	reg	sel_pipec2r1d;
	reg	sel_pipec3r1d;
	wire  [4:0]  dir_w;
	wire  direction_w;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper1d <= 13'b0;
		else if  (clk_en == 1'b1)   sbit_piper1d <= smux_w[25:13];
	// synopsys translate_off
	initial
		sbit_piper2d = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper2d <= 13'b0;
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[51:39];
	// synopsys translate_off
	initial
		sel_pipec2r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		pad_w = {8{1'b0}},
		result = sbit_w[64:52],
		sbit_w = {sbit_piper2d, smux_w[38:26], sbit_piper1d, smux_w[12:0], data},
		sel_w = {sel_pipec3r1d, sel_pipec2r1d, distance[1:0]},
		smux_w = {((({13{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[43:39], pad_w[7:0]}) | ({13{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[51:47]})) | ({13{(~ sel_w[3])}} & sbit_w[51:39])), ((({13{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[34:26], pad_w[3:0]}) | ({13{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[38:30]})) | ({13{(~ sel_w[2])}} & sbit_w[38:26])), ((({13{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[23:13], pad_w[1:0]}) | ({13{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[25:15]})) | ({13{(~ sel_w[1])}} & sbit_w[25:13])), ((({13{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[11:0], pad_w[0]}) | ({13{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[12:1]})) | ({13{(~ sel_w[0])}} & sbit_w[12:0]))};
endmodule //int2FP_altbarrel_shift_rvf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2FP_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //int2FP_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2FP_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //int2FP_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2FP_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	int2FP_altpriority_encoder_3v7   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q));
	int2FP_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
...
endmodule //int2FP_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2FP_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	int2FP_altpriority_encoder_3e8   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q),
	.zero(wire_altpriority_encoder12_zero));
	int2FP_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //int2FP_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2FP_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	int2FP_altpriority_encoder_6v7   altpriority_encoder8
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder8_q));
	int2FP_altpriority_encoder_6e8   altpriority_encoder9
	( 
	.data(data[7:4]),
...
endmodule //int2FP_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2FP_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	int2FP_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	int2FP_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
endmodule //int2FP_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2FP_altpriority_encoder_rb6
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	int2FP_altpriority_encoder_bv7   altpriority_encoder6
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder6_q));
	int2FP_altpriority_encoder_be8   altpriority_encoder7
	( 
	.data(data[15:8]),
...
endmodule //int2FP_altpriority_encoder_rb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 213 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2FP_altfp_convert_i5o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	wire  [12:0]   wire_altbarrel_shift5_result;
	...
	reg	[11:0]	mag_int_a_reg;
	reg	[11:0]	mag_int_a_reg2;
	...
	wire  [12:0]  prio_mag_int_a;
	wire  [2:0]  priority_pad_one_w;
	wire  [63:0]  result_w;
	wire  [11:0]  shifted_mag_int_a;
	wire  sign_bus;
	wire  sign_int_a;
	wire  [6:0]  zero_padding_w;

	int2FP_altbarrel_shift_rvf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	int2FP_altpriority_encoder_rb6   altpriority_encoder2
	( 
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg <= 12'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg2 <= 12'b0;
	...
	assign
		...
		const_bias_value_add_width_int_w = 11'b10000001010,
		...
		mag_int_a = (({12{(~ sign_int_a)}} & int_a) | ({12{sign_int_a}} & int_a_2s)),
		mantissa_bus = mantissa_rounded[51:0],
		mantissa_pre_round = {shifted_mag_int_a[11:0], {41{1'b0}}},
		mantissa_rounded = mantissa_pre_round_reg,
		max_neg_value_selector = (wire_cmpr4_alb & sign_int_a_reg2),
		max_neg_value_w = 11'b10000001011,
		minus_leading_zero = {zero_padding_w, leading_zeroes},
		prio_mag_int_a = {mag_int_a_reg, 1'b1},
		priority_pad_one_w = {3{1'b1}},
		result = result_reg,
		result_w = {sign_bus, exponent_bus, mantissa_bus},
		shifted_mag_int_a = wire_altbarrel_shift5_result[11:0],
		sign_bus = sign_int_a_reg5,
		sign_int_a = dataa[12],
		zero_padding_w = {7{1'b0}};
endmodule //int2FP_altfp_convert_i5o
//VALID FILE
...
module int2FP (
	...
	int2FP_altfp_convert_i5o	int2FP_altfp_convert_i5o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
