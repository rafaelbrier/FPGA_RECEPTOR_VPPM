...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" EXCEPTION_HANDLING="NO" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=11 WIDTH_MAN=52 aclr clk_en clock dataa datab nan overflow result underflow zero
...
`endif
	...
	assign
		...
		zero = zero_ff;
endmodule //multFP_altfp_mult_ulr
//VALID FILE
...
module multFP (
	...
	multFP_altfp_mult_ulr	multFP_altfp_mult_ulr_component (
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
